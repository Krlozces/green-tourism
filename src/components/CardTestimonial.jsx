...
export default function CardTestimonial({ name, text }) {
    return (
        <>
            <div role="list" className="bg-white flex flex-col justify-center items-center rounded-md py-4 px-6 my-4 w-80">
                <div>
                        ...
                        <li>
                            ...
                            width="105" height="78" className="absolute left-6 top-6 fill-slate-100">
                                ...
                                <blockquote className="relative">
                                    <p className="text-lg tracking-tight text-slate-900">{text}</p>
                                </blockquote>
